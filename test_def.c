...
#include <string.h>
#include "my_string.h"
Status test_hjoshi_get_capacity_on_init_default_returns_7(char* buffer, int length)
{
    ...
    if(my_string_get_capacity(hString) != 7)
 {
    ...
    strncpy(buffer, "test_hjoshi_get_capacity_on_init_default_returns_7\n"
...
Status test_hjoshi_my_string_c_str_returns_correct_NULL_terminated_string(char* buffer, int length) {
    Status status = FAILURE;
    ...
    if (bad != 0) {
        ...
        strncpy(buffer, "test_hjoshi_my_string_c_str_returns_correct_NULL_terminated_string\n"
...
Status test_hjoshi_my_string_destroy_sets_pointer_to_NULL(char* buffer, int length) {
    Status status = FAILURE;
    ...
    if (hMy_string1 != NULL) {
        ...
        strncpy(buffer, "test_hjoshi_my_string_destroy_sets_pointer_to_NULL\n"
...
Status test_hjoshi_my_string_extraction_returns_success_on_success(char* buffer, int length) {
    FILE* fp;
    ...
    if (status != SUCCESS)
    {
        ...
        strncpy(buffer, "test_hjoshi_my_string_extraction_returns_success_on_success\n"
...
Status test_hjoshi_my_string_concat_increases_right_amount_of_capacity(char* buffer, int length) {
    Status status = FAILURE;
    ...
    if (my_string_get_capacity(hMy_string1) != 12)
    {
        ...
        strncpy(buffer, "test_hjoshi_my_string_concat_increases_right_amount_of_capacity\n"
...
Status test_hjoshi_my_string_concat_increases_right_amount_of_size(char* buffer, int length) {
    Status status = FAILURE;
    MY_STRING hMy_string1 = my_string_init_c_string("Hello ");
    MY_STRING hMy_string2 = my_string_init_c_string("World");
    my_string_concat(hMy_string1, hMy_string2);
    if (my_string_get_size(hMy_string1) != 11)
    {
        ...
        strncpy(buffer, "test_hjoshi_my_string_concat_increases_right_amount_of_size\n"
...
Status test_hjoshi_my_string_insertion_returns_success_on_success(char* buffer, int length) {
     Status status = FAILURE;
     MY_STRING hMy_string1 = my_string_init_c_string("Hello World");
     ...
     if (status != SUCCESS)
     {
         ...
         strncpy(buffer, "test_hjoshi_my_string_insertion_returns_success_on_success\n"
...
Status test_hjoshi_my_string_push_back_increases_right_amount_of_capacity(char* buffer, int length) {
    Status status = FAILURE;
    MY_STRING hMy_string1 = my_string_init_c_string("Hello World");
    ...
    if (my_string_get_capacity(hMy_string1) != 24)
    {
        ...
        strncpy(buffer, "test_hjoshi_my_string_push_back_increases_right_amount_of_capacity\n"
...
Status test_hjoshi_my_string_push_back_increases_right_amount_of_size(char* buffer, int length) {
    Status status = FAILURE;
    MY_STRING hMy_string1 = my_string_init_c_string("Hello World");
    my_string_push_back(hMy_string1, '!');
    if (my_string_get_size(hMy_string1) != 12)
    {
        ...
        strncpy(buffer, "test_hjoshi_my_string_push_back_increases_right_amount_of_size\n"
...
Status test_hjoshi_my_string_pop_back_decreases_right_amount_of_size(char* buffer, int length) {
    Status status = FAILURE;
    MY_STRING hMy_string1 = my_string_init_c_string("Hello World");
    ...
    if (my_string_get_size(hMy_string1) != 10)
    {
        ...
        strncpy(buffer, "test_hjoshi_my_string_pop_back_decreases_right_amount_of_size\n"
...
Status test_hjoshi_my_string_at_returns_NULL_if_index_out_of_bounds(char* buffer, int length) {
    Status status = FAILURE;
    MY_STRING hMy_string1 = my_string_init_c_string("Hello");
    ...
    if (b != NULL)
    {
       ...
       strncpy(buffer, "test_hjoshi_my_string_at_returns_NULL_if_index_out_of_bounds\n"
...
Status test_hjoshi_my_string_at_returns_correct_character_at_valid_index(char* buffer, int length) {
    Status status = FAILURE;
    ...
    if ('e' !=*temp) {
        ...
        strncpy(buffer, "test_hjoshi_my_string_at_returns_correct_character_at_valid_index\n"
...
Status test_hjoshi_my_string_init_c_string_creates_correct_string(char* buffer, int length) {
    Status status = FAILURE;
    MY_STRING hMy_string1 = my_string_init_c_string("Hello World");
    int bad = 0;
    char* correct = "Hello World";
    ...
    if (bad != 0) {
        ...
        strncpy(buffer, "test_hjoshi_my_string_init_c_string_creates_correct_string\n"
...
Status test_hjoshi_my_string_empty_returns_false_on_NON_empty_string(char* buffer, int length) {
    Status status = FAILURE;
    MY_STRING hMy_string1 = my_string_init_c_string("hello");
    if (my_string_empty(hMy_string1) != FALSE)
    {
        ...
        strncpy(buffer, "test_hjoshi_test_my_string_empty_returns_false_on_NON_empty_string\n"
...
Status test_hjoshi_my_string_empty_returns_true_on_empty_string(char* buffer, int length) {
    Status status = FAILURE;
    MY_STRING hMy_string1 = my_string_init_default();
    if (my_string_empty(hMy_string1) != TRUE)
    {
        printf("Expected 1 (for TRUE) from my_string_empty but got %d\n", my_string_empty(hMy_string1));
        strncpy(buffer, "test_hjoshi_test_my_string_empty_returns_true_on_empty_string\n"
...
Status test_hjoshi_my_string_concat_returns_correct_string(char* buffer, int length) {
    Status status = FAILURE;
    ...
    if (works !=0)
    {
        ...
        strncpy(buffer, "test_hjoshi_my_string_concat_returns_correct_string\n"
...
Status test_hjoshi_my_string_pop_back_deletes_last_character_in_string(char* buffer, int length) {
    Status status = FAILURE;
    ...
    if (bad !=0)
    {
        ...
        strncpy(buffer, "test_hjoshi_my_string_pop_back_deletes_last_character_in_string\n"
...
Status test_hjoshi_my_string_push_back_creates_correct_new_string(char* buffer, int length) {
    Status status = FAILURE;
    MY_STRING hMy_string = NULL;
    ...
    if (works !=0)
    {
        ...
        strncpy(buffer, "test_hjoshi_my_string_push_back_creates_correct_new_string\n"
...
Status test_hjoshi_get_pos_value_on_my_string_compare(char* buffer, int length)
{
    Status status = FAILURE;
     ...
     if (check <= 0||check==0xBEEF)
        ...
        strncpy(buffer, "test_hjoshi_get_pos_value_on_my_string_compare\n"
...
Status test_hjoshi_get_neg_value_on_my_string_compare(char* buffer, int length)
{
    Status status = FAILURE;
    ...
    if (my_string_compare(apple1, apple2) >= 0){
        ...
        strncpy(buffer, "test_hjoshi_get_neg_value_on_my_string_compare\n"
...
Status test_hjoshi_get_zero_on_same_my_string_compare(char* buffer, int length)
{
    Status status = FAILURE;
    ...
    if (my_string_compare(apple1, apple2) != 0)
        ...
        strncpy(buffer, "test_hjoshi_get_zero_on_same_my_string_compare\n"
...
Status test_hjoshi_get_capacity_of_six_on_init_hello(char* buffer, int length)
{   
    Status status = FAILURE;
    MY_STRING hString = NULL;
    ...
    if(my_string_get_capacity(hString) != 6)
    {
        ...
        strncpy(buffer, "test_hjoshi_get_capacity_of_six_on_init_hello\n"
...
Status test_hjoshi_get_size_of_five_on_init_hello(char* buffer, int length)
{
   Status status = FAILURE;	
   MY_STRING hString = NULL;
   hString = my_string_init_c_string("hello");
   if(my_string_get_size(hString) != 5)
   {
        ...
        strncpy(buffer, "test_hjoshi_get_size_of_five_on_init_hello\n"
...
Status test_hjoshi_init_default_returns_nonNULL(char* buffer, int length)
{
        Status status = FAILURE;
        MY_STRING hString = NULL;
        hString = my_string_init_default();
        if(hString == NULL)
 {
        strncpy(buffer, "test_hjoshi_init_default_returns_nonNULL\n"
...
Status test_hjoshi_get_size_on_init_default_returns_0(char* buffer, int length)
{
        Status status=FAILURE;
        MY_STRING hString = NULL;
        hString = my_string_init_default();
        if(my_string_get_size(hString) != 0)
 {
        ...
        strncpy(buffer, "test_hjoshi_get_size_on_init_default_returns_0\n"
